...
async def create_node_type(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.add_type,
            params.id,
            params.to_create_schema(),
        )
        return JSONResponse(
            content={
                "status": "success",
                "message": "Node type created",
                "id": params.id,
            },
...
async def update_node_type(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.change_type, params.to_update_schema()
        )
        return JSONResponse(
            content={
                "status": "success",
...
async def delete_node_type(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.delete_type, params.id
        )
        return JSONResponse(
            content={
                "status": "success",
...
async def create_node(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.add_node, params.to_create_schema()
        )
        return JSONResponse(
            content={
                "status": "success",
...
async def update_node(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.change_node, params.to_update_schema()
        )
        return JSONResponse(
            content={
                "status": "success",
...
async def delete_node(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.delete_node, params.id
        )
        return JSONResponse(
            content={
                "status": "success",
...
async def create_connection(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.add_conn, params.to_create_schema()
        )
        return JSONResponse(
            content={
                "status": "success",
...
async def update_connection(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.change_conn, params.to_update_schema()
        )
        return JSONResponse(
            content={
                "status": "success",
...
async def delete_connection(
    ...
    try:
        await request.app.state.synchronizer.execute_async(
            request.app.state.map.delete_conn, params.id
        )
        return JSONResponse(
            content={
                "status": "success",
